...
//                            ])
//
//                            SettingsSection(title: "Account Settings", items: [
//                                ProfileItem(icon: "lock.rotation", iconColor: .orange, title: "Reset Password", enabled: true, action: {
...
//                                ProfileItem(icon: "envelope.fill", iconColor: .purple, title: "Update Email", enabled: true, destination: AnyView(UpdateEmailView())),
